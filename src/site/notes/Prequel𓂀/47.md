...
Among these invaluable witnesses, catalogued under the Gregory-Aland system, the earliest known fragment is likely the very brief **Papyrus 98 (P98)** (2nd century). Ranking second or very close in age is **Papyrus 115 (P115)**, often dated to the late 2nd or early-to-mid 3rd century. Like P98, P115 is _highly_ fragmentary, only preserving very small portions of several chapters. However, the next in the lineage, and following these in scholarly dating, lies **Papyrus 47 (P47)** (typically estimated as mid-to-late 3rd century). While technically the third oldest known fragment among these key papyri, it preserves a much larger, actually continuous block of text – roughly the middle third of Revelation (chapters 9-17). Being so early and substantial in its size, P47 provides scholars with the earliest extensive text for this section of Revelation, significantly closer in time to the original late 1st-century writing than many later manuscripts, despite its relatively informal script. Another important piece, and the next oldest known fragment after P47 among these key papyri, is **Papyrus 18 (P18)**, a 3rd/4th-century fragment containing Revelation 1:4-7. It is notable for being written on the back of a reused Exodus scroll fragment, early Christians demonstrating the timelessness of the reduce reuse and recycle theorem.
